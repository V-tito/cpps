...
entry:
  ...
  %.2316 = icmp sgt i64 %.243, 0
  %or.cond17 = or i1 %.11, %.2316
  br i1 %or.cond17, label %Loop_2_entry.lr.ph, label %Loop_1_follower
...
Loop_2_entry.lr.ph:                               ; preds = %entry
  ...
  %.419 = icmp sgt i64 %.182, 0
  %or.cond110 = or i1 %.29, %.419
  %.47 = extractvalue { i1, i64 } %.5, 0
  %.58 = extractvalue { i1, i64 } %.5, 1
  %.594 = icmp sgt i64 %.58, 0
  %or.cond25 = select i1 %.47, i1 true, i1 %.594
...
Loop_2_entry:                                     ; preds = %Loop_2_entry.lr.ph, %Loop_1_reduction_0_init
  %.2121 = phi i64 [ 1, %Loop_2_entry.lr.ph ], [ %.18, %Loop_1_reduction_0_init ]
  %i20 = phi { i1, i64 } [ { i1 false, i64 1 }, %Loop_2_entry.lr.ph ], [ %.20, %Loop_1_reduction_0_init ]
  %.24119 = phi { i1, { ptr, i32 } } [ %.256, %Loop_2_entry.lr.ph ], [ %.242, %Loop_1_reduction_0_init ]
  %allocated_size_red_1.118 = phi i32 [ %.247, %Loop_2_entry.lr.ph ], [ %.296, %Loop_1_reduction_0_init ]
  ...
  br i1 %or.cond110, label %Loop_3_entry.lr.ph, label %Loop_2_follower

Loop_3_entry.lr.ph:                               ; preds = %Loop_2_entry
  %.63 = extractvalue { i1, i64 } %i20, 0
  %.64 = or i1 %.61, %.63
  %.69 = trunc i64 %.2121 to i32
  %.70 = add i32 %.69, -1
...
Loop_2_follower:                                  ; preds = %Loop_2_reduction_0_init, %Loop_2_entry
  %.180.lcssa = phi { i1, { ptr, i32 } } [ %.195, %Loop_2_entry ], [ %.181, %Loop_2_reduction_0_init ]
  %.259 = extractvalue { i1, { ptr, i32 } } %.24119, 0
  br i1 %.259, label %Loop_1_reduction_0_init, label %Loop_1_reduction_1_cond_block

Loop_3_entry:                                     ; preds = %Loop_3_entry.lr.ph, %Loop_2_reduction_0_init
  %.3914 = phi i64 [ 1, %Loop_3_entry.lr.ph ], [ %.36, %Loop_2_reduction_0_init ]
  %j13 = phi { i1, i64 } [ { i1 false, i64 1 }, %Loop_3_entry.lr.ph ], [ %.38, %Loop_2_reduction_0_init ]
  %.18012 = phi { i1, { ptr, i32 } } [ %.195, %Loop_3_entry.lr.ph ], [ %.181, %Loop_2_reduction_0_init ]
  %allocated_size_red_111 = phi i32 [ %.186, %Loop_3_entry.lr.ph ], [ %.235, %Loop_2_reduction_0_init ]
  br i1 %or.cond25, label %Loop_3_body_start.lr.ph, label %Loop_3_follower

Loop_3_body_start.lr.ph:                          ; preds = %Loop_3_entry
  %.123 = extractvalue { i1, i64 } %j13, 0
  %.129 = trunc i64 %.3914 to i32
  %.130 = add i32 %.129, -1
  %3 = zext nneg i32 %.130 to i64
  br label %Loop_3_body_start

Loop_3_body_start:                                ; preds = %Loop_3_body_start.lr.ph, %ArrayAccess_phi_block.3
  %lsr.iv = phi i64 [ 2, %Loop_3_body_start.lr.ph ], [ %lsr.iv.next, %ArrayAccess_phi_block.3 ]
  %k7 = phi { i1, i64 } [ { i1 false, i64 1 }, %Loop_3_body_start.lr.ph ], [ %.56, %ArrayAccess_phi_block.3 ]
  %.1536 = phi { i1, i64 } [ zeroinitializer, %Loop_3_body_start.lr.ph ], [ %.154, %ArrayAccess_phi_block.3 ]
  br i1 %brmerge, label %ArrayAccess_phi_block, label %ArrayAccess_correct_exec_block

Loop_3_follower:                                  ; preds = %ArrayAccess_phi_block.3, %Loop_3_entry
  %.153.lcssa = phi { i1, i64 } [ zeroinitializer, %Loop_3_entry ], [ %.154, %ArrayAccess_phi_block.3 ]
  %.198 = extractvalue { i1, { ptr, i32 } } %.18012, 0
...
ArrayAccess_correct_exec_block.1:                 ; preds = %array_access_out_of_bounds_check.1
  ...
  %tmp25 = trunc i64 %5 to i32
  %4 = zext nneg i32 %tmp25 to i64
...
array_access_out_of_bounds_check.1:               ; preds = %ArrayAccess_phi_block
  ...
  %5 = add i64 %lsr.iv, -2
  %tmp26 = trunc i64 %5 to i32
  %.91 = icmp slt i32 %tmp26, 0
  %tmp27 = trunc i64 %5 to i32
  %.92 = icmp slt i32 %.88, %tmp27
  %.93 = or i1 %.91, %.92
...
ArrayAccess_correct_exec_block.2:                 ; preds = %array_access_out_of_bounds_check.2
  %tmp = trunc i64 %7 to i32
  %6 = zext nneg i32 %tmp to i64
  %.116 = getelementptr { i1, { ptr, i32 } }, ptr %.115, i64 %6
...
array_access_out_of_bounds_check.2:               ; preds = %ArrayAccess_phi_block.1
  %7 = add i64 %lsr.iv, -2
  %tmp23 = trunc i64 %7 to i32
  %.111 = icmp slt i32 %tmp23, 0
  %tmp24 = trunc i64 %7 to i32
  %.112 = icmp slt i32 %.108, %tmp24
  %.113 = or i1 %.111, %.112
...
ArrayAccess_phi_block.3:                          ; preds = %ArrayAccess_phi_block.2, %array_access_out_of_bounds_check.3, %ArrayAccess_correct_exec_block.3
  ...
  %.159 = extractvalue { i1, i64 } %.1536, 0
  %.163 = or i1 %.159, %.146
  %.169 = extractvalue { i1, i64 } %.1536, 1
  %.171 = add i64 %.149, %.169
  %.173 = insertvalue { i1, i64 } zeroinitializer, i64 %.171, 1
  %.154 = select i1 %.163, { i1, i64 } { i1 true, i64 0 }, { i1, i64 } %.173
  %.56 = insertvalue { i1, i64 } zeroinitializer, i64 %lsr.iv, 1
  %.59 = icmp sle i64 %lsr.iv, %.58
...
Loop_2_reduction_0_init:                          ; preds = %Loop_3_follower, %arr_size_exceeds_allocated_not, %arr_size_exceeds_allocated
  ...
  %.235 = phi i32 [ %.213, %arr_size_exceeds_allocated ], [ %allocated_size_red_111, %arr_size_exceeds_allocated_not ], [ undef, %Loop_3_follower ]
  %.36 = add i64 %.3914, 1
  %.38 = insertvalue { i1, i64 } zeroinitializer, i64 %.36, 1
  %.41 = icmp sle i64 %.36, %.182
...
Loop_2_reduction_1_cond_block:                    ; preds = %Loop_3_follower
  %.207 = extractvalue { i1, { ptr, i32 } } %.18012, 1
  %.208 = extractvalue { ptr, i32 } %.207, 1
  %.209 = add i32 %.208, 1
  %.210 = insertvalue { ptr, i32 } %.207, i32 %.209, 1
  %.211 = icmp ugt i32 %.209, %allocated_size_red_111
...
arr_size_exceeds_allocated:                       ; preds = %Loop_2_reduction_1_cond_block
  %.213 = shl i32 %allocated_size_red_111, 1
  %11 = sext i32 %.213 to i64
  %.216.idx = mul nsw i64 %11, 12
  %.219 = tail call ptr @realloc(ptr %.192, i64 %.216.idx)
  %12 = sext i32 %.208 to i64
  %.220 = getelementptr { i1, i64 }, ptr %.219, i64 %12
  store { i1, i64 } %.153.lcssa, ptr %.220, align 4
...
arr_size_exceeds_allocated_not:                   ; preds = %Loop_2_reduction_1_cond_block
  %13 = sext i32 %.208 to i64
  %.228 = getelementptr { i1, i64 }, ptr %.192, i64 %13
  store { i1, i64 } %.153.lcssa, ptr %.228, align 4
...
Loop_1_reduction_0_init:                          ; preds = %Loop_2_follower, %arr_size_exceeds_allocated_not.1, %arr_size_exceeds_allocated.1
  ...
  %.296 = phi i32 [ %.274, %arr_size_exceeds_allocated.1 ], [ %allocated_size_red_1.118, %arr_size_exceeds_allocated_not.1 ], [ undef, %Loop_2_follower ]
  %.18 = add i64 %.2121, 1
...
Loop_1_reduction_1_cond_block:                    ; preds = %Loop_2_follower
  %.268 = extractvalue { i1, { ptr, i32 } } %.24119, 1
  %.269 = extractvalue { ptr, i32 } %.268, 1
  %.270 = add i32 %.269, 1
  %.271 = insertvalue { ptr, i32 } %.268, i32 %.270, 1
  %.272 = icmp ugt i32 %.270, %allocated_size_red_1.118
...
arr_size_exceeds_allocated.1:                     ; preds = %Loop_1_reduction_1_cond_block
  %.274 = shl i32 %allocated_size_red_1.118, 1
  %14 = sext i32 %.274 to i64
  %.277.idx = mul nsw i64 %14, 24
  %.280 = tail call ptr @realloc(ptr %.253, i64 %.277.idx)
  %15 = sext i32 %.269 to i64
  %.281 = getelementptr { i1, { ptr, i32 } }, ptr %.280, i64 %15
...
arr_size_exceeds_allocated_not.1:                 ; preds = %Loop_1_reduction_1_cond_block
  %16 = sext i32 %.269 to i64
  %.289 = getelementptr { i1, { ptr, i32 } }, ptr %.253, i64 %16
